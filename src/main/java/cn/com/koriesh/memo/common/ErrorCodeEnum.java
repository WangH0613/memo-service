...
public enum ErrorCodeEnum {
    ...
    USER_ERROR_A0154("A0154", "菜单信息校验失败"),
    ...
    SYSTEM_ERROR_B0010("B0010", "系统运行异常"),  // Exception、RuntimeException、NullPointerException
    SYSTEM_ERROR_B0011("B0011", "I/O异常"), // IOException
    SYSTEM_ERROR_B0012("B0012", "token认证失败"), // AuthenticationException
    SYSTEM_ERROR_B0013("B0013", "用户权限不足"),  // UnauthorizedException
    SYSTEM_ERROR_B0020("B0020", "导入数据存在重复"),  // 导入数据存在重复
